/**
 * Files Data Layer — Zod schemas and derived types.
 *
...
export const SiteFileTypeSchema = z.enum([
...
export type SiteFileType = z.infer<typeof SiteFileTypeSchema>

// ---------------------------------------------------------------------------
// SiteFile
// ---------------------------------------------------------------------------

const SiteFileBlobSchema = z.object({
  mimeType: z.string(),
  base64: z.string(),
})
...
export const SiteFileSchema = z.object({
   ...
   */
  blob: SiteFileBlobSchema.optional().catch(undefined),
